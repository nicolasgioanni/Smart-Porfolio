...
Research visual snapshots inject controlled local-template Research items for deterministic baselines, while component and alignment coverage remains generated-workbook dependent.
